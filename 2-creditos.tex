...
\textbf{tradução do posfácio\,©}\quad	     {Sergio Paulo Rouanet}\\
\textbf{desenhos}\quad			 			 {Franz Kafka}\\
%\textbf{copyright}\quad 					 {Nome do autor}\\
%\textbf{ilustração}\quad			 		 {copyrightilustracao}\medskip

\textit{Os desenhos de Franz Kafka foram reproduzidos de \emph{Einzelblätter}}\\
\textit{[Folhas avulsas] (1901--1907) e \emph{Zeichnungsheft} [Caderno de desenhos]} \\
\textit{(sem data). Espólio Literário de Max Brod, Biblioteca Nacional de Israel.}\\
...
\textit{A transformação}. Franz Kafka; tradução e introdução de Celso Donizete Cruz; posfácio de Walter Benjamin e Otto Maria Carpeaux. 3.\,ed. São Paulo, \textsc{sp}: Hedra, 2025. \\
