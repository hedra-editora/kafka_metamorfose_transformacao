...
\noindent{}\textls[10]{O mundo do contista Franz Kafka é uma casa burguesa, solidamente construída na aparência, com uma fachada um pouco descuidada. Entramos, e respiramos o ar das penúrias dolorosas, de quartos mal ventilados. Apodera-se de nós o sentimento
...
Voltamo-nos para o outro lado: aparece a face de Deus.}\looseness=-1
...
pesada.'' É a ameaça mortal que antecede a esperança vital.}\looseness=-1
...
\textls[15]{Esses terrores e esses esplendores, Kafka os escondeu nos andrajos da vida cotidiana, pois ``quem vir descoberta a face de Deus morrerá''.}\looseness=-1
...
judaico e pelo misticismo eslavo.}\looseness=-1

\begin{quote}
\begin{verse}
\textit{Estou}\\
\textit{Limitado ao norte pelos sentidos, ao sul pelo medo}\\
\textls[-20]{\textit{A leste pelo apóstolo São Paulo, a oeste pela minha educação.}}\looseness=-1\footnote{Excerto de poema de Murilo Mendes. \textsc{{[}n.\,e.{]}}}
\end{verse}
\end{quote}
...
manuscritos, que o executor, Max Brod, editará arbitrariamente.}\looseness=-1
...
adivinhar um outro mundo.}\looseness=-1

\pagebreak

\noindent{}\textls[5]{As personagens falam, comem, dormem, seguem os
caminhos escuros e estreitos; mas são os caminhos do inferno e do
paraíso, são os caminhos \textit{per realia ad realiora}.}\looseness=-1\footnote{``Pelas coisas reais ao mais real.''}
...
\begin{quote}
\textls[15]{Quando \textsc{k.} está à morte, chega a decisão definitiva do castelo: \textsc{k.} não tem nenhum direito de permanecer na aldeia; mas considerando-se certas circunstâncias acessórias, ser-lhe-á permitido que aí permaneça até a morte.}\looseness=-1
\end{quote}
...
em seu favor, perante o tribunal de Deus. A despeito dele, o seu dia chegará, se já não chegou.}\looseness=-1
...
\textls[15]{Todos esses obstáculos aprofundam
...
\textls[15]{Feita a abstração de alguns pontos de contato com Heinrich von Kleist, o Kleist
...
na literatura europeia do pós-guerra.}\looseness=-1

\textls[-5]{O simbolismo de Kafka perturba
o mundo, pela estranha transposição dos acentos, pela desvalorização dos fatos tradicionais, pela revelação de um mundo mais real atrás do mundo real dos bem-pensantes: \textit{per realia ad realiora}. Eis o lema de Anton Tchécov, a quem Kafka deve a técnica do conto. Mas
...
\textls[-5]{Esta ausência do tempo humano destrói a estrutura
...
não representar nada perante Deus? }\looseness=-1
\end{quote}
...
\begin{center}\adforn{19}\end{center}
...
\textls[-10]{Ao repelir o fardo das cobertas, o pai repele
...
particularmente aplicável ao filho:}

\begin{quote}
\textls[15]{O pecado original, o velho delito
...
\textls[10]{Mas quem é acusado desse pecado original, hereditário --- o
...
\textls[-15]{Entre a administração e a família, Kafka vê contatos múltiplos. Na
 aldeia de Schlossberg havia para isso uma expressão eloquente.}

\begin{quote}
 \textls[20]{Temos aqui uma expressão que você talvez conheça: as decisões administrativas
 ...
 \textls[20]{Entre essas qualidades comuns talvez a mais notável fosse a de
...
\textls[15]{Voltaremos a essa terra
...
\begin{quote}
\textls[15]{É um fenômeno notável, de certo modo científico\ldots{} Não pode
...
\textls[15]{Essas palavras estabelecem um vínculo com aqueles
...
\begin{quote}
\textls[15]{instalaram-se num canto do chão, sobre dois velhos
...
\textls[20]{Para eles e seus semelhantes, os
...
ninguém pode extinguir.}\looseness=-1
\end{quote}
...
\textls[20]{Essa tristeza profunda foi talvez um dia compensada pelo fervoroso
desejo de ``ser índio''. }

\begin{quote}
\textls[10]{Como seria bom ser um índio, sempre pronto, a
...
\textls[5]{Essa pista é ao mesmo tempo um teatro, e isso constitui um enigma. Mas o
...
\textls[-20]{Assim como essa campainha,
...
\textls[2]{Se é certo, como diz Max Brod, que ``era imenso o mundo dos fatos que
...
\begin{quote}
\textls[20]{levantou cuidadosamente os olhos\ldots{} pegou um dos papéis, sem olhá-lo,
...
\textls[5]{Kafka queria ser incluído entre esses homens comuns. Pouco a pouco os
limites de sua compreensão se tornaram evidentes. Ele quer mostrar aos
outros esses limites. Às vezes ele se parece com \textit{O Grande Inquisidor}, de
Dostoiévski: }

\begin{quote}
\textls[20]{Estamos, portanto, em presença de um mistério, que não
...
\noindent{}\textls[20]{--- Teatro?, perguntou um deles, pedindo conselho ao outro, com os lábios trêmulos.}

\noindent{}Este reagiu como um mudo, que luta com um organismo recalcitrante.
\end{quote}

\textls[20]{Eles não responderam à pergunta, mas esses indícios fazem supor que
...
\textls[8]{As reflexões póstumas de Kafka, contidas em \textit{A grande muralha da China},
...
romance, \textit{Amerika}. }
\end{quote}

\textls[20]{O primeiro terço dessa interpretação constitui
hoje, a partir de Brod, patrimônio comum da exegese kafkiana. Assim, por
exemplo, escreve Bernhard Rang:}

\begin{quote}
\textls[20]{Na medida em que o castelo pode ser
...
\textls[20]{Em suas especulações bárbaras, que de resto não são sequer compatíveis
...
\begin{quote}
\textls[15]{o objeto desse processo, o verdadeiro herói desse livro inacreditável, é o
...
\textls[15]{Não podemos afastar de todo a hipótese de
...
\begin{quote}
\textls[15]{Aqui a plenitude do mundo é considerada a única realidade. Todo
...
\textls[15]{Odradek é o aspecto assumido pelas coisas em estado de esquecimento.
...
\begin{quote}
\textls[20]{Para ficar tão pesado quanto possível, o que considero bom
...
\textls[15]{Conta-se que numa aldeia hassídica alguns judeus estavam sentados numa
 ...
 respondeu, com alguma relutância:}\looseness=-1
...
pensou nisso. É com uma certeza desse gênero que seu avô diz: }\looseness=-1
...
\textls[10]{Como se vê, os tolos têm afinidades com
...
\textls[10]{Mas talvez possamos compreender
...
\textls[15]{Kafka não se cansa de dar corpo ao gesto, em descrições desse tipo. Mas
...
depósito de carvão. Infeliz também seu cavalo, infelizes os dois.}\looseness=-1
