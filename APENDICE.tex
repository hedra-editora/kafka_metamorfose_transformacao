...
\textit{A leste pelo apóstolo São Paulo, a oeste pela minha\qb{}educação.}\footnote{Excerto de poema de Murilo Mendes. \textsc{{[}n.\,e.{]}}}
\end{verse}
\end{quote}
...
adivinhar um outro mundo.

\pagebreak

\noindent{}As personagens falam, comem, dormem, seguem os
...
pré-história exerce seu domínio ainda mais ilimitadamente.\looseness=-1
...
\textls[-10]{Kafka não se cansa de dar corpo ao gesto, em descrições desse tipo. Mas
...
\textls[-10]{Nenhuma região é mais
...
direito que não é mais praticado, e sim estudado.}\looseness=-1
