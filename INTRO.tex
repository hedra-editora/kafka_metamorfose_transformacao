...
sentença de abertura mais célebre de toda a literatura.\endnote{ “Als 
...
obra.\endnote{ Cf. Celso Cruz. \textit{Metamorfoses de Kafka}, São
Paulo: Annablume, 2007.} É o livro que fisga o leitor e lhe abre as
portas para o universo kafkiano.\endnote{ Alguns colegas reivindicam
...
foi muita coisa que ele deixou vir a público enquanto vivia.\endnote{
...
não ultrapassam quinhentas páginas.\endnote{ São 447, numa contagem
...
Borges é um dos que referem o episódio,\endnote{ Num conhecido prólogo
...
contato inicial preciso com a mais pura ficção kafkiana.\endnote{
...
Alemanha.\endnote{ Luiz Costa Lima comprova em \textit{Limites da voz:
...
como uma “expedição à verdade”.\endnote{ “Dichtung ist immer nur eine
...
Mairowitz\endnote{ \textit{Kafka de Crumb}, trad. José Gradel, Rio de
...
alguns relatos biográficos.\endnote{ Cf., por exemplo, Anthony
