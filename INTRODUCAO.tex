...
\textit{A transformação} é um bom exemplo para tanto. Em parte por ser sua
obra mais popular e ter sido publicada com o autor ainda vivo. Não
foi muita coisa que ele deixou vir a público enquanto vivia.\footnote{\textls[-10]{Há opinião diversa, como a de Osman Durrani, no \textit{\mbox{The Cambridge}
...
Companion to Kafka, \textit{op.\,cit.}}, p.\,208.} A economia narrativa e o rigor no acabamento
...
Borges é um dos que referem o episódio,\footnote{\textls[-10]{Num conhecido prólogo
...
\textls[-15]{Se bem entendo a lição, diviso uma metodologia nessa busca de conversão do
...
que vem a ser a confirmação de uma intenção realista.}\looseness=-1
...
literária, antes que um “médium” da expressão de forças superiores.\looseness=-1
